...
class CraverControlEnv(gym.Env):
    """
    Each iteration, gets the latest network file that was generated by the higher level agent.
    Never gets the original unmodified net file.
    However, the trips are scaled based on the original net file. The pedestrians are then re-routed based on the new net file.
    """
    def __init__(self, config, worker_id=None, network_iteration=None):
        super().__init__()
        self.config = config  
